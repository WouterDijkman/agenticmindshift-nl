...
const TRACKS = [
  {
    ...
    body: 'Agentic Mindshift levert het volledige AI Due Diligence & Portfolio-traject op uw dossier — op vier momenten: acquisitie, financiering, portfolio review of pre-IBR/WHOA. Powered by Factum Capital. De scorecard bepaalt welk moment als eerste relevant is.',
  ...
  },
  {
    ...
    body: 'Factum Capital is vanaf 1 juli 2026 beschikbaar als SaaS. 23 modules voor uw eigen deal-team of adviseurspraktijk — van IM-screening tot exit-readiness tot pre-IBR signalering. Inschrijving voor vroege toegang is nu open.',
