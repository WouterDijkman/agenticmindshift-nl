...
const hoeIkWerk = [
  {
    ...
    body: 'Doorlopende intelligence-laag over uw deelnemingen, met maandelijkse MBR-rapportage en AI-substitutiemonitoring.',
    price: '€8.500 / maand',
  },
  {
    n: '02',
  ...
  },
  {
    ...
    body: 'Twee tot drie dagen per maand onderdeel van uw dealteam of portfoliobedrijf — voor AI-adoptie en bias-toetsing.',
    price: '€6.500 / maand',
  },
  {
    n: '04',
    title: 'Masterclasses',
    body: 'Eendaagse masterclasses voor dealteams van maximaal acht personen, over AI-substitutierisico en MBR-discipline.',
