...
const PAINS: { code: string; label: string; title: string; body: string; Icon: SketchIconComponent }[] = [
  {
    ...
    body: 'AI-substitutierisico en operationele concentratie zijn zelden zichtbaar in een IM. Ze worden pas zichtbaar als de deal getekend is — of de portefeuille in stress zit.',
  ...
  },
  {
    ...
    body: 'Onderprestatie en exit-obstakels sluimeren kwartalen voordat de jaarrapportage het bevestigt. Vroegtijdige signalering vereist structuur die er zelden is.',
