...
/**
 * INTERN, ALLEEN NEDERLANDS. Deze namen en beschrijvingen zijn brontekst voor
 * de (Nederlandstalige) rapport-prompt en mogen nooit rechtstreeks aan een
 * lead worden getoond. Voor zichtbare tekst: getOfferName() uit
 * lib/pdf/offerRoutes.ts, die de naam uit messages/<locale>.json haalt.
 */
