...
export default function Sectie2Page() {
  ...
  const section = getLocalizedQuestionsBySection(locale, 2);
  ...
  return (
    <section className="container-medium py-10">
      ...
      >
        ...
        <h1 className="type-h2" style={{ marginBottom: '16px' }}>{t('sections.s2_title')}</h1>
        <p
          style={{
            fontSize: '1.0625rem',
